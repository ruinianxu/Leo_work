"""autogenerated by genpy from moveit_msgs/GetKinematicSolverInfoRequest.msg. Do not edit."""
import sys
...
class GetKinematicSolverInfoRequest(genpy.Message):
  ...
  _type = "moveit_msgs/GetKinematicSolverInfoRequest"
...
"""autogenerated by genpy from moveit_msgs/GetKinematicSolverInfoResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetKinematicSolverInfoResponse(genpy.Message):
  ...
  _type = "moveit_msgs/GetKinematicSolverInfoResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """KinematicSolverInfo kinematic_solver_info
...
"""
  ...
  _slot_types = ['moveit_msgs/KinematicSolverInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kinematic_solver_info is None:
        self.kinematic_solver_info = moveit_msgs.msg.KinematicSolverInfo()
    else:
      self.kinematic_solver_info = moveit_msgs.msg.KinematicSolverInfo()
...
class GetKinematicSolverInfo(object):
  _type          = 'moveit_msgs/GetKinematicSolverInfo'
  _md5sum = '9b591d98efeb66095c1b33a70221cab5'
