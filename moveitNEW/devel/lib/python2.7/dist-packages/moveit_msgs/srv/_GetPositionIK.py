    ...
    try:
      ...
      for val1 in self.ik_request.robot_state.attached_collision_objects:
        ...
        for val3 in _v103.plane_poses:
          ...
          _x = _v112
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v103.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.ik_request.constraints.visibility_constraints:
        ...
        _v129 = _v128.header
        buff.write(_struct_I.pack(_v129.seq))
        _v130 = _v129.stamp
        _x = _v130
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v129.frame_id
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v151.id = str[start:end].decode('utf-8')
        else:
        ...
        (_v151.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        for val3 in _v199.plane_poses:
          ...
          _x = _v208
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v199.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v219.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v222.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v222.db = str[start:end].decode('utf-8')
        else:
    ...
    try:
      ...
      for val1 in self.solution.attached_collision_objects:
        ...
        for val3 in _v239.plane_poses:
          ...
          _x = _v248
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v239.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v260.seq,) = _struct_I.unpack(str[start:end])
        _v261 = _v260.stamp
        _x = _v261
        start = end
        end += 8
        ...
        if python3:
          _v260.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v259.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v262.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v262.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v259.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
