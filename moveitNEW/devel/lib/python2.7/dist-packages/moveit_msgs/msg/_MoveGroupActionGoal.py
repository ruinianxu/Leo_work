...
class MoveGroupActionGoal(genpy.Message):
  _md5sum = "5a63f1e432efa5831f25bdbf4067e372"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.goal.request.num_planning_attempts, _x.goal.request.allowed_planning_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.request.num_planning_attempts, _x.goal.request.allowed_planning_time,) = _struct_id.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
