...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.target_point_offset.x, _x.target_point_offset.y, _x.target_point_offset.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target_point_offset.x, _x.target_point_offset.y, _x.target_point_offset.z,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
