  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v28.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v31.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v31.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v28.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.state.attached_collision_objects:
        ...
        for val3 in _v49.plane_poses:
          ...
          _x = _v58
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v49.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v70.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v73.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v73.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v70.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
