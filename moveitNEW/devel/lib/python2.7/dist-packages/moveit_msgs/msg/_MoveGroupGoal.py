...
class MoveGroupGoal(genpy.Message):
  _md5sum = "6f87a65b68d345a6821303c17412a990"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.request.workspace_parameters.header.seq, _x.request.workspace_parameters.header.stamp.secs, _x.request.workspace_parameters.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_6d3I.pack(_x.request.workspace_parameters.min_corner.x, _x.request.workspace_parameters.min_corner.y, _x.request.workspace_parameters.min_corner.z, _x.request.workspace_parameters.max_corner.x, _x.request.workspace_parameters.max_corner.y, _x.request.workspace_parameters.max_corner.z, _x.request.start_state.joint_state.header.seq, _x.request.start_state.joint_state.header.stamp.secs, _x.request.start_state.joint_state.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.request.start_state.multi_dof_joint_state.header.seq, _x.request.start_state.multi_dof_joint_state.header.stamp.secs, _x.request.start_state.multi_dof_joint_state.header.stamp.nsecs))
      ...
      buff.write(_struct_B.pack(self.request.start_state.is_diff))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.request.num_planning_attempts, _x.request.allowed_planning_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.request.workspace_parameters.header.seq, _x.request.workspace_parameters.header.stamp.secs, _x.request.workspace_parameters.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.request.workspace_parameters.min_corner.x, _x.request.workspace_parameters.min_corner.y, _x.request.workspace_parameters.min_corner.z, _x.request.workspace_parameters.max_corner.x, _x.request.workspace_parameters.max_corner.y, _x.request.workspace_parameters.max_corner.z, _x.request.start_state.joint_state.header.seq, _x.request.start_state.joint_state.header.stamp.secs, _x.request.start_state.joint_state.header.stamp.nsecs,) = _struct_6d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.request.start_state.multi_dof_joint_state.header.seq, _x.request.start_state.multi_dof_joint_state.header.stamp.secs, _x.request.start_state.multi_dof_joint_state.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.request.start_state.is_diff,) = _struct_B.unpack(str[start:end])
      ...
      (_x.request.num_planning_attempts, _x.request.allowed_planning_time,) = _struct_id.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
