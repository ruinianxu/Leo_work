...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.multi_dof_joint_state.header.seq, _x.multi_dof_joint_state.header.stamp.secs, _x.multi_dof_joint_state.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.multi_dof_joint_state.header.seq, _x.multi_dof_joint_state.header.stamp.secs, _x.multi_dof_joint_state.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
