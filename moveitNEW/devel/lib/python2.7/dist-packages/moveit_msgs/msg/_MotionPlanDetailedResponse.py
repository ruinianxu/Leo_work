  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v41.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v44.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v44.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v41.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v75.plane_poses:
          ...
          _x = _v84
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v75.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v109.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v112.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v112.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v109.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
