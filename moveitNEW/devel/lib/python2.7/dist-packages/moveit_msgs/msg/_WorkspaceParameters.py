...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.min_corner.x, _x.min_corner.y, _x.min_corner.z, _x.max_corner.x, _x.max_corner.y, _x.max_corner.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.min_corner.x, _x.min_corner.y, _x.min_corner.z, _x.max_corner.x, _x.max_corner.y, _x.max_corner.z,) = _struct_6d.unpack(str[start:end])
      return self
