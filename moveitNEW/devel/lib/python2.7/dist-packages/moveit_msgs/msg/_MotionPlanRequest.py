...
class MotionPlanRequest(genpy.Message):
  _md5sum = "7cd790e04c3a55f6742ec387a72a02d6"
...
"""
  __slots__ = ['workspace_parameters','start_state','goal_constraints','path_constraints','trajectory_constraints','planner_id','group_name','num_planning_attempts','allowed_planning_time']
  _slot_types = ['moveit_msgs/WorkspaceParameters','moveit_msgs/RobotState','moveit_msgs/Constraints[]','moveit_msgs/Constraints','moveit_msgs/TrajectoryConstraints','string','string','int32','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       workspace_parameters,start_state,goal_constraints,path_constraints,trajectory_constraints,planner_id,group_name,num_planning_attempts,allowed_planning_time
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.num_planning_attempts, _x.allowed_planning_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num_planning_attempts, _x.allowed_planning_time,) = _struct_id.unpack(str[start:end])
      return self
