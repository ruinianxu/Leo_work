...
if("TRUE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/leo/Dropbox/Thesis/Projects/moveitNEW/build/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /usr/local)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_plugins/moveit_fake_controller_manager/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_fake_controller_manager_dep}_FOUND)
      find_package(${moveit_fake_controller_manager_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_fake_controller_manager_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(moveit_fake_controller_manager_INCLUDE_DIRS ${${moveit_fake_controller_manager_dep}_INCLUDE_DIRS})
  list(APPEND moveit_fake_controller_manager_LIBRARIES ${${moveit_fake_controller_manager_dep}_LIBRARIES})
...
if(moveit_fake_controller_manager_LIBRARIES)
  _remove_duplicate_libraries(moveit_fake_controller_manager_LIBRARIES moveit_fake_controller_manager_LIBRARIES)
endif()
