...
if("TRUE" STREQUAL "TRUE")
  set(moveit_ros_warehouse_SOURCE_PREFIX /home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_ros/warehouse)
  set(moveit_ros_warehouse_DEVEL_PREFIX /home/leo/Dropbox/Thesis/Projects/moveitNEW/build/devel)
  ...
  set(moveit_ros_warehouse_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_ros/warehouse/warehouse/include" STREQUAL "")
  set(moveit_ros_warehouse_INCLUDE_DIRS "")
  set(_include_dirs "/home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_ros/warehouse/warehouse/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_ros_warehouse' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leo/Dropbox/Thesis/Projects/moveitNEW/src/moveit_ros/warehouse/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_ros_warehouse_dep}_FOUND)
      find_package(${moveit_ros_warehouse_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_ros_warehouse_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(moveit_ros_warehouse_INCLUDE_DIRS ${${moveit_ros_warehouse_dep}_INCLUDE_DIRS})
  list(APPEND moveit_ros_warehouse_LIBRARIES ${${moveit_ros_warehouse_dep}_LIBRARIES})
...
if(moveit_ros_warehouse_LIBRARIES)
  _remove_duplicate_libraries(moveit_ros_warehouse_LIBRARIES moveit_ros_warehouse_LIBRARIES)
endif()
