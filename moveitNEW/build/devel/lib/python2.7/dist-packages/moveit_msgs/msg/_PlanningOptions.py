...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.planning_scene_diff.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      ...
      buff.write(_struct_B.pack(self.planning_scene_diff.robot_state.is_diff))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.planning_scene_diff.allowed_collision_matrix.default_entry_values))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.planning_scene_diff.world.octomap.header.seq, _x.planning_scene_diff.world.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.planning_scene_diff.world.octomap.octomap.binary))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.planning_scene_diff.world.octomap.octomap.resolution))
      length = len(self.planning_scene_diff.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.planning_scene_diff.world.octomap.octomap.data))
      _x = self
      buff.write(_struct_3BidBid.pack(_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.planning_scene_diff.name = str[start:end].decode('utf-8')
      else:
      ...
      (_x.planning_scene_diff.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene_diff.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      (self.planning_scene_diff.robot_state.is_diff,) = _struct_B.unpack(str[start:end])
      ...
      if python3:
        self.planning_scene_diff.robot_model_name = str[start:end].decode('utf-8')
      else:
      ...
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = struct.unpack(pattern, str[start:end])
      self.planning_scene_diff.allowed_collision_matrix.default_entry_values = map(bool, self.planning_scene_diff.allowed_collision_matrix.default_entry_values)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.planning_scene_diff.world.octomap.header.seq, _x.planning_scene_diff.world.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.world.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.planning_scene_diff.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.planning_scene_diff.world.octomap.origin.position.x, _x.planning_scene_diff.world.octomap.origin.position.y, _x.planning_scene_diff.world.octomap.origin.position.z, _x.planning_scene_diff.world.octomap.origin.orientation.x, _x.planning_scene_diff.world.octomap.origin.orientation.y, _x.planning_scene_diff.world.octomap.origin.orientation.z, _x.planning_scene_diff.world.octomap.origin.orientation.w, _x.planning_scene_diff.world.octomap.octomap.header.seq, _x.planning_scene_diff.world.octomap.octomap.header.stamp.secs, _x.planning_scene_diff.world.octomap.octomap.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene_diff.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.planning_scene_diff.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.planning_scene_diff.world.octomap.octomap.binary,) = _struct_B.unpack(str[start:end])
      ...
      if python3:
        self.planning_scene_diff.world.octomap.octomap.id = str[start:end].decode('utf-8')
      else:
        self.planning_scene_diff.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.planning_scene_diff.world.octomap.octomap.resolution,) = _struct_d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.planning_scene_diff.world.octomap.octomap.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 28
      (_x.planning_scene_diff.is_diff, _x.plan_only, _x.look_around, _x.look_around_attempts, _x.max_safe_execution_cost, _x.replan, _x.replan_attempts, _x.replan_delay,) = _struct_3BidBid.unpack(str[start:end])
