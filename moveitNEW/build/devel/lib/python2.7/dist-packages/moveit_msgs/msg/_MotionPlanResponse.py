  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.trajectory.multi_dof_joint_trajectory.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_di.pack(_x.planning_time, _x.error_code.val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v35.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v38.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v38.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v35.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      (_x.planning_time, _x.error_code.val,) = _struct_di.unpack(str[start:end])
      return self
    ...
    try:
      ...
      for val1 in self.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v63.plane_poses:
          ...
          _x = _v72
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v63.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v91.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v94.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v94.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v91.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        if python3:
          _v102.frame_id = str[start:end].decode('utf-8')
        else:
