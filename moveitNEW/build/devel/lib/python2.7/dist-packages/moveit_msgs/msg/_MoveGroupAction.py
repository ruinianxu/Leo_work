...
class MoveGroupAction(genpy.Message):
  _md5sum = "9bf6e4a7c534d229e5b3e23a36894b5c"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.action_goal.goal.request.num_planning_attempts, _x.action_goal.goal.request.allowed_planning_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.request.num_planning_attempts, _x.action_goal.goal.request.allowed_planning_time,) = _struct_id.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
