...
class MoveGroupResult(genpy.Message):
  _md5sum = "931779c1e9f7b947800524441dba2843"
...
"""
  __slots__ = ['error_code','trajectory_start','planned_trajectory','executed_trajectory']
  _slot_types = ['moveit_msgs/MoveItErrorCodes','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory','moveit_msgs/RobotTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       error_code,trajectory_start,planned_trajectory,executed_trajectory
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i3I.pack(_x.error_code.val, _x.trajectory_start.joint_state.header.seq, _x.trajectory_start.joint_state.header.stamp.secs, _x.trajectory_start.joint_state.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_B3I.pack(_x.trajectory_start.is_diff, _x.planned_trajectory.joint_trajectory.header.seq, _x.planned_trajectory.joint_trajectory.header.stamp.secs, _x.planned_trajectory.joint_trajectory.header.stamp.nsecs))
      ...
      for val1 in self.planned_trajectory.joint_trajectory.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.planned_trajectory.multi_dof_joint_trajectory.header.seq, _x.planned_trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.planned_trajectory.multi_dof_joint_trajectory.header.stamp.nsecs))
      ...
      for val1 in self.planned_trajectory.multi_dof_joint_trajectory.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.executed_trajectory.joint_trajectory.header.seq, _x.executed_trajectory.joint_trajectory.header.stamp.secs, _x.executed_trajectory.joint_trajectory.header.stamp.nsecs))
      ...
      for val1 in self.executed_trajectory.joint_trajectory.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.executed_trajectory.multi_dof_joint_trajectory.header.seq, _x.executed_trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.executed_trajectory.multi_dof_joint_trajectory.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.error_code.val, _x.trajectory_start.joint_state.header.seq, _x.trajectory_start.joint_state.header.stamp.secs, _x.trajectory_start.joint_state.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        (_v43.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      (_x.trajectory_start.is_diff, _x.planned_trajectory.joint_trajectory.header.seq, _x.planned_trajectory.joint_trajectory.header.stamp.secs, _x.planned_trajectory.joint_trajectory.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      (_x.planned_trajectory.multi_dof_joint_trajectory.header.seq, _x.planned_trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.planned_trajectory.multi_dof_joint_trajectory.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.executed_trajectory.joint_trajectory.header.seq, _x.executed_trajectory.joint_trajectory.header.stamp.secs, _x.executed_trajectory.joint_trajectory.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.executed_trajectory.multi_dof_joint_trajectory.header.seq, _x.executed_trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.executed_trajectory.multi_dof_joint_trajectory.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v115.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
