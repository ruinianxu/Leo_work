...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.avoid_collisions))
      ...
      for val1 in self.pose_stamped_vector:
        ...
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      _x = self
      buff.write(_struct_3i.pack(_x.timeout.secs, _x.timeout.nsecs, _x.attempts))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.avoid_collisions,) = _struct_B.unpack(str[start:end])
      ...
      (_x.timeout.secs, _x.timeout.nsecs, _x.attempts,) = _struct_3i.unpack(str[start:end])
      self.timeout.canon()
      return self
