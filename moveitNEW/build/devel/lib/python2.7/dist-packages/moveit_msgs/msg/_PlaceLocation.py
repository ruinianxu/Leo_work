...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.post_place_posture.header.seq, _x.post_place_posture.header.stamp.secs, _x.post_place_posture.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.place_pose.header.seq, _x.place_pose.header.stamp.secs, _x.place_pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.place_pose.pose.position.x, _x.place_pose.pose.position.y, _x.place_pose.pose.position.z, _x.place_pose.pose.orientation.x, _x.place_pose.pose.orientation.y, _x.place_pose.pose.orientation.z, _x.place_pose.pose.orientation.w, _x.pre_place_approach.direction.header.seq, _x.pre_place_approach.direction.header.stamp.secs, _x.pre_place_approach.direction.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f3I.pack(_x.pre_place_approach.direction.vector.x, _x.pre_place_approach.direction.vector.y, _x.pre_place_approach.direction.vector.z, _x.pre_place_approach.desired_distance, _x.pre_place_approach.min_distance, _x.post_place_retreat.direction.header.seq, _x.post_place_retreat.direction.header.stamp.secs, _x.post_place_retreat.direction.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f.pack(_x.post_place_retreat.direction.vector.x, _x.post_place_retreat.direction.vector.y, _x.post_place_retreat.direction.vector.z, _x.post_place_retreat.desired_distance, _x.post_place_retreat.min_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.post_place_posture.header.seq, _x.post_place_posture.header.stamp.secs, _x.post_place_posture.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.place_pose.header.seq, _x.place_pose.header.stamp.secs, _x.place_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.pre_place_approach.direction.vector.x, _x.pre_place_approach.direction.vector.y, _x.pre_place_approach.direction.vector.z, _x.pre_place_approach.desired_distance, _x.pre_place_approach.min_distance, _x.post_place_retreat.direction.header.seq, _x.post_place_retreat.direction.header.stamp.secs, _x.post_place_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.post_place_retreat.direction.vector.x, _x.post_place_retreat.direction.vector.y, _x.post_place_retreat.direction.vector.z, _x.post_place_retreat.desired_distance, _x.post_place_retreat.min_distance,) = _struct_3d2f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.allowed_touch_objects = []
