...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.result.grasp.pre_grasp_posture.header.seq, _x.result.grasp.pre_grasp_posture.header.stamp.secs, _x.result.grasp.pre_grasp_posture.header.stamp.nsecs))
      ...
      for val1 in self.result.grasp.grasp_posture.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.result.grasp.grasp_pose.header.seq, _x.result.grasp.grasp_pose.header.stamp.secs, _x.result.grasp.grasp_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.grasp.id = str[start:end].decode('utf-8')
      else:
        self.result.grasp.id = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.result.grasp.pre_grasp_posture.header.seq, _x.result.grasp.pre_grasp_posture.header.stamp.secs, _x.result.grasp.pre_grasp_posture.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.pre_grasp_posture.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.result.grasp.grasp_posture.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      (_x.result.grasp.grasp_pose.header.seq, _x.result.grasp.grasp_pose.header.stamp.secs, _x.result.grasp.grasp_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.grasp_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.result.grasp.pre_grasp_approach.direction.vector.x, _x.result.grasp.pre_grasp_approach.direction.vector.y, _x.result.grasp.pre_grasp_approach.direction.vector.z, _x.result.grasp.pre_grasp_approach.desired_distance, _x.result.grasp.pre_grasp_approach.min_distance, _x.result.grasp.post_grasp_retreat.direction.header.seq, _x.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.result.grasp.post_grasp_retreat.direction.vector.x, _x.result.grasp.post_grasp_retreat.direction.vector.y, _x.result.grasp.post_grasp_retreat.direction.vector.z, _x.result.grasp.post_grasp_retreat.desired_distance, _x.result.grasp.post_grasp_retreat.min_distance, _x.result.grasp.post_place_retreat.direction.header.seq, _x.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.result.grasp.post_place_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.result.grasp.post_place_retreat.direction.vector.x, _x.result.grasp.post_place_retreat.direction.vector.y, _x.result.grasp.post_place_retreat.direction.vector.z, _x.result.grasp.post_place_retreat.desired_distance, _x.result.grasp.post_place_retreat.min_distance, _x.result.grasp.max_contact_force,) = _struct_3d3f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
