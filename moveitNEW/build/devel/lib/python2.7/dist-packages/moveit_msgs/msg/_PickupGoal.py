...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.minimize_object_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.end_effector = str[start:end].decode('utf-8')
      else:
      ...
      (self.minimize_object_distance,) = _struct_B.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v146.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v149.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v149.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v146.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v168.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v168.db = str[start:end].decode('utf-8')
        else:
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.possible_grasps:
        ...
        _v176 = _v175.header
        buff.write(_struct_I.pack(_v176.seq))
        _v177 = _v176.stamp
        _x = _v177
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v176.frame_id
      ...
      for val1 in self.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v233.plane_poses:
          ...
          _x = _v242
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v233.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v283.seq,) = _struct_I.unpack(str[start:end])
        _v284 = _v283.stamp
        _x = _v284
        start = end
        end += 8
      ...
      for i in range(0, length):
        ...
        if python3:
          _v299.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v303.seq,) = _struct_I.unpack(str[start:end])
        _v304 = _v303.stamp
        _x = _v304
        start = end
        end += 8
      ...
      for i in range(0, length):
        ...
        if python3:
          _v320.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v323.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v323.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v320.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        if python3:
          _v340.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v342.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v342.db = str[start:end].decode('utf-8')
        else:
