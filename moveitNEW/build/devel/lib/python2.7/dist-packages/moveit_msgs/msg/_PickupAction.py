...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.action_goal.goal.minimize_object_distance))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v59.plane_poses:
          ...
          _x = _v68
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v59.operation))
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v94.plane_poses:
          ...
          _x = _v103
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v94.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f3I.pack(_x.action_result.result.grasp.post_grasp_retreat.direction.vector.x, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.y, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.z, _x.action_result.result.grasp.post_grasp_retreat.desired_distance, _x.action_result.result.grasp.post_grasp_retreat.min_distance, _x.action_result.result.grasp.post_place_retreat.direction.header.seq, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f.pack(_x.action_result.result.grasp.post_place_retreat.direction.vector.x, _x.action_result.result.grasp.post_place_retreat.direction.vector.y, _x.action_result.result.grasp.post_place_retreat.direction.vector.z, _x.action_result.result.grasp.post_place_retreat.desired_distance, _x.action_result.result.grasp.post_place_retreat.min_distance, _x.action_result.result.grasp.max_contact_force))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.target_name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.end_effector = str[start:end].decode('utf-8')
      else:
      ...
      (self.action_goal.goal.minimize_object_distance,) = _struct_B.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v182.id = str[start:end].decode('utf-8')
        else:
        ...
        (_v182.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v202.seq,) = _struct_I.unpack(str[start:end])
        _v203 = _v202.stamp
        _x = _v203
        start = end
        end += 8
        ...
        if python3:
          _v204.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v204.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v218.seq,) = _struct_I.unpack(str[start:end])
        _v219 = _v218.stamp
        _x = _v219
        start = end
        end += 8
        ...
        (_v217.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        if python3:
          _v228.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      if python3:
        self.action_result.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.grasp.pre_grasp_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.action_result.result.grasp.pre_grasp_approach.direction.vector.x, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.y, _x.action_result.result.grasp.pre_grasp_approach.direction.vector.z, _x.action_result.result.grasp.pre_grasp_approach.desired_distance, _x.action_result.result.grasp.pre_grasp_approach.min_distance, _x.action_result.result.grasp.post_grasp_retreat.direction.header.seq, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_grasp_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.grasp.post_grasp_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.action_result.result.grasp.post_grasp_retreat.direction.vector.x, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.y, _x.action_result.result.grasp.post_grasp_retreat.direction.vector.z, _x.action_result.result.grasp.post_grasp_retreat.desired_distance, _x.action_result.result.grasp.post_grasp_retreat.min_distance, _x.action_result.result.grasp.post_place_retreat.direction.header.seq, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.secs, _x.action_result.result.grasp.post_place_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.grasp.post_place_retreat.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.action_result.result.grasp.post_place_retreat.direction.vector.x, _x.action_result.result.grasp.post_place_retreat.direction.vector.y, _x.action_result.result.grasp.post_place_retreat.direction.vector.z, _x.action_result.result.grasp.post_place_retreat.desired_distance, _x.action_result.result.grasp.post_place_retreat.min_distance, _x.action_result.result.grasp.max_contact_force,) = _struct_3d3f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.possible_grasps:
        ...
        _v268 = _v267.header
        buff.write(_struct_I.pack(_v268.seq))
        _v269 = _v268.stamp
        _x = _v269
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v268.frame_id
      ...
      for val1 in self.action_goal.goal.path_constraints.orientation_constraints:
        _v284 = val1.header
        buff.write(_struct_I.pack(_v284.seq))
        _v285 = _v284.stamp
        _x = _v285
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v284.frame_id
      ...
      for val1 in self.action_goal.goal.path_constraints.visibility_constraints:
        ...
        _v288 = _v287.header
        buff.write(_struct_I.pack(_v288.seq))
        _v289 = _v288.stamp
        _x = _v289
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v288.frame_id
        ...
        _v294 = _v293.header
        buff.write(_struct_I.pack(_v294.seq))
        _v295 = _v294.stamp
        _x = _v295
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v294.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        _v305 = val1.object
        _v306 = _v305.header
        buff.write(_struct_I.pack(_v306.seq))
        _v307 = _v306.stamp
        _x = _v307
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v306.frame_id
        ...
        for val3 in _v305.plane_poses:
          ...
          _x = _v314
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v305.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v316 = _v315.header
        buff.write(_struct_I.pack(_v316.seq))
        _v317 = _v316.stamp
        _x = _v317
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v316.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        _v319 = val1.header
        buff.write(_struct_I.pack(_v319.seq))
        _v320 = _v319.stamp
        _x = _v320
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v319.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.world.collision_objects:
        _v325 = val1.header
        buff.write(_struct_I.pack(_v325.seq))
        _v326 = _v325.stamp
        _x = _v326
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v325.frame_id
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v340.plane_poses:
          ...
          _x = _v349
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_b.pack(_v340.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v351 = _v350.header
        buff.write(_struct_I.pack(_v351.seq))
        _v352 = _v351.stamp
        _x = _v352
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v351.frame_id
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v371.seq,) = _struct_I.unpack(str[start:end])
        _v372 = _v371.stamp
        _x = _v372
        start = end
        end += 8
        ...
        if python3:
          _v371.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v379.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        (_v386.seq,) = _struct_I.unpack(str[start:end])
        _v387 = _v386.stamp
        _x = _v387
        start = end
        end += 8
        ...
        (_v391.seq,) = _struct_I.unpack(str[start:end])
        _v392 = _v391.stamp
        _x = _v392
        start = end
        end += 8
        ...
        (_v396.seq,) = _struct_I.unpack(str[start:end])
        _v397 = _v396.stamp
        _x = _v397
        start = end
        end += 8
      ...
      for i in range(0, length):
        ...
        (_v399.seq,) = _struct_I.unpack(str[start:end])
        _v400 = _v399.stamp
        _x = _v400
        start = end
        end += 8
        ...
        if python3:
          _v399.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v407.seq,) = _struct_I.unpack(str[start:end])
        _v408 = _v407.stamp
        _x = _v408
        start = end
        end += 8
        ...
        if python3:
          _v407.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v417.seq,) = _struct_I.unpack(str[start:end])
        _v418 = _v417.stamp
        _x = _v418
        start = end
        end += 8
        ...
        if python3:
          _v417.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v429.seq,) = _struct_I.unpack(str[start:end])
        _v430 = _v429.stamp
        _x = _v430
        start = end
        end += 8
        ...
        if python3:
          _v428.id = str[start:end].decode('utf-8')
        else:
        ...
        (_v428.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        (_v442.seq,) = _struct_I.unpack(str[start:end])
        _v443 = _v442.stamp
        _x = _v443
        start = end
        end += 8
        ...
        if python3:
          _v442.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        (_v464.seq,) = _struct_I.unpack(str[start:end])
        _v465 = _v464.stamp
        _x = _v465
        start = end
        end += 8
        ...
        if python3:
          _v463.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v466.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v466.db = str[start:end].decode('utf-8')
        else:
        ...
        (_v463.operation,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        (_v474.seq,) = _struct_I.unpack(str[start:end])
        _v475 = _v474.stamp
        _x = _v475
        start = end
        end += 8
      ...
      for i in range(0, length):
        ...
        (_v478.seq,) = _struct_I.unpack(str[start:end])
        _v479 = _v478.stamp
        _x = _v479
        start = end
        end += 8
