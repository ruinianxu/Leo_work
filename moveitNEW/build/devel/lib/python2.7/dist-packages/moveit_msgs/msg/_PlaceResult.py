...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.place_location.post_place_posture.header.seq, _x.place_location.post_place_posture.header.stamp.secs, _x.place_location.post_place_posture.header.stamp.nsecs))
      ...
      for val1 in self.place_location.post_place_posture.points:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.place_location.place_pose.header.seq, _x.place_location.place_pose.header.stamp.secs, _x.place_location.place_pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f.pack(_x.place_location.post_place_retreat.direction.vector.x, _x.place_location.post_place_retreat.direction.vector.y, _x.place_location.post_place_retreat.direction.vector.z, _x.place_location.post_place_retreat.desired_distance, _x.place_location.post_place_retreat.min_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.place_location.id = str[start:end].decode('utf-8')
      else:
        self.place_location.id = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.place_location.post_place_posture.header.seq, _x.place_location.post_place_posture.header.stamp.secs, _x.place_location.post_place_posture.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.post_place_posture.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      (_x.place_location.place_pose.header.seq, _x.place_location.place_pose.header.stamp.secs, _x.place_location.place_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.place_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.place_location.place_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.place_location.place_pose.pose.position.x, _x.place_location.place_pose.pose.position.y, _x.place_location.place_pose.pose.position.z, _x.place_location.place_pose.pose.orientation.x, _x.place_location.place_pose.pose.orientation.y, _x.place_location.place_pose.pose.orientation.z, _x.place_location.place_pose.pose.orientation.w, _x.place_location.pre_place_approach.direction.header.seq, _x.place_location.pre_place_approach.direction.header.stamp.secs, _x.place_location.pre_place_approach.direction.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.place_location.pre_place_approach.direction.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.place_location.pre_place_approach.direction.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 44
      (_x.place_location.pre_place_approach.direction.vector.x, _x.place_location.pre_place_approach.direction.vector.y, _x.place_location.pre_place_approach.direction.vector.z, _x.place_location.pre_place_approach.desired_distance, _x.place_location.pre_place_approach.min_distance, _x.place_location.post_place_retreat.direction.header.seq, _x.place_location.post_place_retreat.direction.header.stamp.secs, _x.place_location.post_place_retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
